      ...
      cards: [
        {
          ...
          body:
            "The teaching is completely free — there's no tuition and no profit. The only cost is the shared workspace we meet in, split between students per session. In return, you commit fully — attend every session, complete the project, and help shape what this becomes.",
        },
        {
          icon: "🎯",
      ...
      cards: [
        {
          ...
          title: "ليه مجاني؟",
          body:
            "التعليم مجاني بالكامل — مفيش مصاريف دراسة ولا أرباح. التكلفة الوحيدة هي المكان المشترك اللي بنتقابل فيه، وبتتقسم على الطلاب لكل session. في المقابل، انت بتلتزم بالكامل — تحضر كل session، تخلص البروجيكت، وتساعد في بناء اللي هييجي بعده.",
        },
        {
          icon: "🎯",
          title: "هتطلع بإيه",
